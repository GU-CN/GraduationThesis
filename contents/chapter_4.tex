...
Each arm uses the custom gripper developed during DR3. An assembly contains two screw-mounted fingers printed in TPU~64D. Each finger has an overall bounding-box size of
\[
