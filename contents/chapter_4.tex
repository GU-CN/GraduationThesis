...
Figure~\ref{fig:ch4-fr3-workspace} shows the placement of the shared task region. The 855~mm maximum reach is not treated as an invitation to place objects at the boundary: motion near maximum extension reduces available orientation freedom and can bring the arm closer to singular configurations.
