...
\newcommand{\CoverInfoZh}{%
  ...
  \begin{tabular}{@{}l@{\hspace{0.8em}}l@{\hspace{3em}}l@{}}
    ...
    \CoverLabelZh{导师} & \ThesisSupervisorZh & \\
...
% 英文封面标签：固定宽度左对齐，Name / Supervisor / College 左缘对齐
\newcommand{\CoverLabelEn}[1]{\hbox to 9em{\textbf{#1}:\hss}}
...
\newcommand{\CoverInfoEn}{%
  ...
  \begin{tabular}{@{}l@{\hspace{0.8em}}l@{\hspace{2.5em}}l@{}}
    ...
    \CoverLabelEn{Supervisor} & \ThesisSupervisorEn & \\
