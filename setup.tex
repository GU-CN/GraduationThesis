...
\sjtusetup{
  ...
  info = {%
    ...
    % 标题
    %
    zh / title           = {面向3C工业生产线的双臂机器人视觉-语言-动作模型},
    en / title           = {Vision-Language-Action Model for Bimanual Robotic Arm in 3C Industrial Production Line
},
    %
    % 标题页标题
    %   可使用“\\”命令手动控制换行
    ...
    % 姓名
    %
    zh / author          = {杨皓然\quad 吴律\quad 吴毅昕\\程天纵\quad 顾益铭},
    en / author          = {\textbf{Yang Haoran, Wu Lv, Wu Yixin,}\\\textbf{Cheng Tianzong, Gu Yiming}},
    %
    % 指导教师
    %
    zh / supervisor      = {李四},
    ...
    % 学号（与作者顺序一一对应）
    %
    id              = {520XXXXXXXX\quad 520XXXXXXXX\quad 520XXXXXXXX\\520XXXXXXXX\quad 520XXXXXXXX},
    %
    % 学位
    %   本科生不需要填写
    %
